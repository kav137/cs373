...
class robot:
    ...
    def move(self, motion): # Do not change the name of this function
        ...
        turn_radius = self.length / tan(steering_angle)
        turn_angle = distance / turn_radius
        turn_point_x = self.x - turn_radius * sin(self.orientation)
        turn_point_y = self.y + turn_radius * cos(self.orientation)
        self.orientation += turn_angle
        self.x = turn_point_x + turn_radius * sin(self.orientation)
        self.y = turn_point_y - turn_radius * cos(self.orientation)
